...
## Requirements
```bash
conda create -n VSUM python=3.8.13
conda activate VSUM
...
## Transforming the Video Summarization task into an NLP Task
...
## Few-Shot Video SUMmarization (FS-VSUM)
<p align="center">
<img src="./fig/FS-VSUM.png" alt="model" width="80%">
</p>

Please run the following command for FS-VSUM method.
