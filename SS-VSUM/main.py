...
def main(args):
    ...
    for i in range(len(video_dataset)):
        ...
        print(video_name)
        video_dir = f"../datasets/{args.dataset}/videos/{video_name}/SS-VSUM"
    ...
    os.makedirs(f'../datasets/{args.dataset}/results/SS-VSUM',exist_ok=True)
    with open(f'../datasets/{args.dataset}/results/SS-VSUM/{save_result_name}', 'a') as file:
